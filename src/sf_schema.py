...
SCHEMA: dict[str, dict] = {
    "TVRS_Guest__c": {
        ...
        "key_fields": [
            ...
            {"name": "Country__c", "type": "string"},
            {
                "name": "Language__c",
                "type": "picklist",
                "note": "English, Spanish, Portuguese, Unknown",
            },
    ...
    "Account": {
        ...
        "key_fields": [
            ...
            {
                "name": "Primary_Language__pc",
                "type": "picklist",
                "note": "Custom person account field",
            },
            {
                "name": "BillingState",
                "type": "string",
            ...
            {"name": "BillingCity", "type": "string"},
            {
                "name": "BillingCountry",
                "type": "string",
                "note": "Full name, e.g. 'United States'",
            },
            {
                "name": "ShippingState",
                "type": "string",
                "note": "Full name; often blank — prefer BillingState",
            },
    ...
    "Task": {
        ...
        "key_fields": [
            ...
            {"name": "Status", "type": "picklist"},
            {
                "name": "WhatId",
                "type": "reference",
                "note": "Polymorphic: Account, Opportunity, etc.",
            },
